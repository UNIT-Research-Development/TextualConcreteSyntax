 ...
 * introduced subclass. 
 */
public class SWMLActivator extends AbstractUIPlugin {
	
	private static final Logger logger = Logger.getLogger(SWMLActivator.class);
	...
	private static SWMLActivator INSTANCE;
	
	public static final String MDSE_BOOK_SWML = "mdse.book.SWML";
	...
	public static SWMLActivator getInstance() {
		return INSTANCE;
	}
	
	protected Module getRuntimeModule(String grammar) {
		if (MDSE_BOOK_SWML.equals(grammar)) {
			return new mdse.book.SWMLRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (MDSE_BOOK_SWML.equals(grammar)) {
			return new mdse.book.ui.SWMLUiModule(this);
		}
